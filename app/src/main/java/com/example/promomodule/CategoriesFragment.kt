...
import com.example.promomodule.viewModel.EstablishmentsViewModel
...
class CategoriesFragment : Fragment() {
    ...
    private val viewModel by lazy { ViewModelProviders.of(this).get(EstablishmentsViewModel::class.java) }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var adapter = CategoriesFragmentAdapter()
        ...
        viewModel.getFireStoreEstablishments(param1!!)
